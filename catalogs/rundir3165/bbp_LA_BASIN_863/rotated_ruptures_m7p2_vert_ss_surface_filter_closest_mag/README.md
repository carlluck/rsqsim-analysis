# Bruce 3165 Rotated Rupture Variability, M7.2 SS
...
|-----|-----|-----|
| Rupture | 306 | Unique (but similar in faulting style and magnitude) ruptures which match the given scenario. |
| Site | 1 | Unique site locations. If 3-d, each will have unique velocity profiles. |
| Rupture Strike | 18 | Rupture strike conforming to the Aki & Richards (1980) convention, where dipping faults dip to the right of the rupture. If path rotation is also performed, this azimuth is relative to the path. |
| Path | 1 | Path from the site to the centroid of the rupture, in azimuthal degrees (0 is North) |
| Distance | 20.0, 50.0, 100.0 km | 3-dimensional distance between the site and the rupture surface. |
| **Total # Simulations** | **16524** | Total number of combinations of the above. |

## M7.2 SS RSQSim Rupture Match Criteria
*[(top)](#table-of-contents)*

We condisder 306 events in the catalog which match the following criteria:
...
|-----|-----|-----|-----|-----|-----|-----|
| Source-strike | &phi;<sub>s</sub> | 20 km | 0.62 | 0.53 | 0.42 | 0.38 |
| Source-strike | &phi;<sub>s</sub> | 50 km | 0.7 | 0.64 | 0.59 | 0.61 |
| Source-strike | &phi;<sub>s</sub> | 100 km | 0.66 | 0.67 | 0.65 | 0.63 |
| Within-event, single-site | &phi;<sub>SS</sub> | 20 km | 0.62 | 0.53 | 0.42 | 0.38 |
| Within-event, single-site | &phi;<sub>SS</sub> | 50 km | 0.7 | 0.64 | 0.59 | 0.61 |
| Within-event, single-site | &phi;<sub>SS</sub> | 100 km | 0.66 | 0.67 | 0.65 | 0.63 |
| Between-events | &tau; | 20 km | 0.21 | 0.2 | 0.21 | 0.25 |
| Between-events | &tau; | 50 km | 0.21 | 0.23 | 0.25 | 0.29 |
| Between-events | &tau; | 100 km | 0.17 | 0.24 | 0.27 | 0.32 |
...
|-----|-----|-----|-----|-----|-----|-----|-----|-----|-----|-----|-----|-----|-----|-----|-----|-----|-----|-----|-----|
|  | 0.62 | 0.61 | 0.61 | [0.34 0.9] |  | 0.53 | 0.52 | 0.52 | [0.21 0.88] |  | 0.42 | 0.41 | 0.4 | [0.18 0.71] |  | 0.38 | 0.37 | 0.36 | [0.15 0.72] |
...
| 3s &phi;<sub>s</sub> | Total | Mean | Median | Range | 5s &phi;<sub>s</sub> | Total | Mean | Median | Range | 7.5s &phi;<sub>s</sub> | Total | Mean | Median | Range | 10s &phi;<sub>s</sub> | Total | Mean | Median | Range |
|-----|-----|-----|-----|-----|-----|-----|-----|-----|-----|-----|-----|-----|-----|-----|-----|-----|-----|-----|-----|
|  | 0.7 | 0.7 | 0.7 | [0.43 0.94] |  | 0.64 | 0.63 | 0.64 | [0.32 1.01] |  | 0.59 | 0.58 | 0.57 | [0.36 0.85] |  | 0.61 | 0.61 | 0.6 | [0.38 0.97] |
...
| 3s &phi;<sub>s</sub> | Total | Mean | Median | Range | 5s &phi;<sub>s</sub> | Total | Mean | Median | Range | 7.5s &phi;<sub>s</sub> | Total | Mean | Median | Range | 10s &phi;<sub>s</sub> | Total | Mean | Median | Range |
|-----|-----|-----|-----|-----|-----|-----|-----|-----|-----|-----|-----|-----|-----|-----|-----|-----|-----|-----|-----|
|  | 0.66 | 0.66 | 0.66 | [0.36 0.91] |  | 0.67 | 0.67 | 0.67 | [0.39 1.06] |  | 0.65 | 0.65 | 0.65 | [0.36 0.99] |  | 0.63 | 0.63 | 0.62 | [0.34 0.97] |
...
|-----|-----|-----|-----|-----|-----|-----|-----|-----|-----|-----|-----|
| 0.21 | -2.66 | [-3.27 -2.06] | 0.2 | -3.46 | [-4.07 -2.94] | 0.21 | -4.04 | [-4.63 -3.48] | 0.25 | -4.52 | [-5.18 -3.91] |
...
| 3s &tau; | Mean &delta;B<sub>e</sub> | &delta;B<sub>e</sub> Range | 5s &tau; | Mean &delta;B<sub>e</sub> | &delta;B<sub>e</sub> Range | 7.5s &tau; | Mean &delta;B<sub>e</sub> | &delta;B<sub>e</sub> Range | 10s &tau; | Mean &delta;B<sub>e</sub> | &delta;B<sub>e</sub> Range |
|-----|-----|-----|-----|-----|-----|-----|-----|-----|-----|-----|-----|
| 0.21 | -3.62 | [-4.24 -3.02] | 0.23 | -4.2 | [-4.86 -3.55] | 0.25 | -4.68 | [-5.37 -4.09] | 0.29 | -5.12 | [-5.8 -4.35] |
...
| 3s &tau; | Mean &delta;B<sub>e</sub> | &delta;B<sub>e</sub> Range | 5s &tau; | Mean &delta;B<sub>e</sub> | &delta;B<sub>e</sub> Range | 7.5s &tau; | Mean &delta;B<sub>e</sub> | &delta;B<sub>e</sub> Range | 10s &tau; | Mean &delta;B<sub>e</sub> | &delta;B<sub>e</sub> Range |
|-----|-----|-----|-----|-----|-----|-----|-----|-----|-----|-----|-----|
| 0.17 | -4.26 | [-4.94 -3.74] | 0.24 | -4.78 | [-5.58 -4.15] | 0.27 | -5.18 | [-5.94 -4.59] | 0.32 | -5.59 | [-6.44 -4.82] |
