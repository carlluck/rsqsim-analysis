...
* [Rupture Plots](#rupture-plots)
  ...
  * [Slip/Vel Animation](resources/rupture_plot_1318657.gif)
  * [Map Plot](#map-plot)
...
|-----|-----|-----|-----|-----|-----|
| *(Total)* | 563.01 km^2 | 405 | 5.58e19 N-m | M7.13 | 6.28 m |
| San Andreas (Mojave S) | 474.66 km^2 | 340 | 4.82e19 N-m | M7.09 | 6.28 m |
| San Andreas (San Bernardino N) | 88.35 km^2 | 65 | 7.59e18 N-m | M6.55 | 4.87 m |
...
![Slip/Time Plot](resources/rupture_plot_1318657.png)
### Slip/Vel Animation
*[(top)](#table-of-contents)*

[Click here to view Slip/Velocity Animation](resources/rupture_plot_1318657.gif)
### Map Plot
*[(top)](#table-of-contents)*

![Map Plot](resources/rupture_map_plot_1318657.png)
...
|-----|-----|-----|
| Horizontal | 61.25 km | 61.51 km |
| 3-D | 63.13 km | 61.51 km |
...
| Distance | Actual RSQSim Surface | GMPE Surface |
|-----|-----|-----|
| Horizontal | 74.94 km | 75.42 km |
| 3-D | 76.48 km | 75.42 km |
...
| Distance | Actual RSQSim Surface | GMPE Surface |
|-----|-----|-----|
| Horizontal | 79.51 km | 80.74 km |
| 3-D | 80.97 km | 80.74 km |
...
![OSI RotD50 Plot](resources/rotd50_spectra_OSI.png)
#### OSI RotD Ratio
*[(top)](#table-of-contents)*

![OSI RotD Ratio Plot](resources/rotd_ratio_OSI.png)
...
| Distance | Actual RSQSim Surface | GMPE Surface |
|-----|-----|-----|
| Horizontal | 64.62 km | 65.75 km |
| 3-D | 66.41 km | 65.75 km |
...
![PDE RotD50 Plot](resources/rotd50_spectra_PDE.png)
#### PDE RotD Ratio
*[(top)](#table-of-contents)*

![PDE RotD Ratio Plot](resources/rotd_ratio_PDE.png)
...
| Distance | Actual RSQSim Surface | GMPE Surface |
|-----|-----|-----|
| Horizontal | 77.57 km | 78.38 km |
| 3-D | 79.07 km | 78.38 km |
...
![WSS RotD50 Plot](resources/rotd50_spectra_WSS.png)
#### WSS RotD Ratio
*[(top)](#table-of-contents)*

![WSS RotD Ratio Plot](resources/rotd_ratio_WSS.png)
...
| Distance | Actual RSQSim Surface | GMPE Surface |
|-----|-----|-----|
| Horizontal | 77.35 km | 77.49 km |
| 3-D | 78.84 km | 77.49 km |
...
![LAF RotD50 Plot](resources/rotd50_spectra_LAF.png)
#### LAF RotD Ratio
*[(top)](#table-of-contents)*

![LAF RotD Ratio Plot](resources/rotd_ratio_LAF.png)
...
| Distance | Actual RSQSim Surface | GMPE Surface |
|-----|-----|-----|
| Horizontal | 121.89 km | 122.90 km |
| 3-D | 122.85 km | 122.90 km |
...
![s022 RotD50 Plot](resources/rotd50_spectra_s022.png)
#### s022 RotD Ratio
*[(top)](#table-of-contents)*

![s022 RotD Ratio Plot](resources/rotd_ratio_s022.png)
