# Bruce 4682 Rotated Rupture Variability, M6.6 SS
...
|-----|-----|-----|
| Rupture | 78 | Unique (but similar in faulting style and magnitude) ruptures which match the given scenario. |
| Site | 1 | Unique site locations. If 3-d, each will have unique velocity profiles. |
| Rupture Strike | 18 | Rupture strike conforming to the Aki & Richards (1980) convention, where dipping faults dip to the right of the rupture. If path rotation is also performed, this azimuth is relative to the path. |
| Path | 1 | Path from the site to the centroid of the rupture, in azimuthal degrees (0 is North) |
| Distance | 20.0, 50.0, 100.0 km | 3-dimensional distance between the site and the rupture surface. |
| **Total # Simulations** | **4212** | Total number of combinations of the above. |

## M6.6 SS Rupture Match Criteria
*[(top)](#table-of-contents)*

We condisder 78 events which match the following criteria:
...
In the case of more than 78 available matches, we use the Sect Variability filter method: Minimizes parent fault section duplication
...
Actual magnitude range: [6.555269,6.6491857], average: 6.6090593, stdDev: 0.026379663
...
|-----|-----|-----|-----|-----|-----|-----|-----|
| Source-strike | &phi;<sub>s</sub> | 20 km | 0.48 | 0.51 | 0.46 | 0.36 | 0.27 |
| Source-strike | &phi;<sub>s</sub> | 50 km | 0.57 | 0.5 | 0.58 | 0.64 | 0.62 |
| Source-strike | &phi;<sub>s</sub> | 100 km | 0.56 | 0.53 | 0.61 | 0.65 | 0.55 |
| Source-strike | &phi;<sub>s</sub> | (all) | 0.54 | 0.52 | 0.55 | 0.56 | 0.5 |
| Within-event, single-site | &phi;<sub>SS</sub> | 20 km | 0.48 | 0.51 | 0.46 | 0.36 | 0.27 |
| Within-event, single-site | &phi;<sub>SS</sub> | 50 km | 0.57 | 0.5 | 0.58 | 0.64 | 0.62 |
| Within-event, single-site | &phi;<sub>SS</sub> | 100 km | 0.56 | 0.53 | 0.61 | 0.65 | 0.55 |
| Within-event, single-site | &phi;<sub>SS</sub> | (all) | 0.54 | 0.52 | 0.55 | 0.56 | 0.5 |
| Between-events | &tau; | 20 km | 0.36 | 0.41 | 0.4 | 0.36 | 0.32 |
| Between-events | &tau; | 50 km | 0.38 | 0.5 | 0.37 | 0.35 | 0.35 |
| Between-events | &tau; | 100 km | 0.4 | 0.58 | 0.37 | 0.38 | 0.36 |
| Between-events | &tau; | (all) | 0.38 | 0.5 | 0.38 | 0.36 | 0.34 |
...
|-----|-----|-----|-----|-----|-----|-----|-----|-----|-----|-----|-----|-----|-----|-----|-----|-----|-----|-----|-----|
|  | 0.51 | 0.51 | 0.54 | [0.29 0.69] |  | 0.46 | 0.47 | 0.49 | [0.27 0.6] |  | 0.36 | 0.37 | 0.37 | [0.23 0.5] |  | 0.27 | 0.28 | 0.28 | [0.15 0.4] |
...
|-----|-----|-----|-----|-----|-----|
| T-independent | 0.48 | 0.46 | 0.05 | [0.41 0.51] | [0.37 0.55] |
| 1 | 0.58 | 0.55 | 0.09 | [0.47 0.65] | [0.37 0.73] |
| 2 | 0.59 | 0.58 | 0.09 | [0.48 0.67] | [0.39 0.73] |
| 3 | 0.51 | 0.51 | 0.07 | [0.43 0.58] | [0.36 0.65] |
| 4 | 0.48 | 0.48 | 0.06 | [0.4 0.54] | [0.35 0.58] |
| 5 | 0.46 | 0.45 | 0.05 | [0.41 0.51] | [0.34 0.55] |
| 7.5 | 0.36 | 0.36 | 0.03 | [0.32 0.39] | [0.3 0.43] |
| 10 | 0.27 | 0.27 | 0.02 | [0.24 0.29] | [0.22 0.31] |
...
| 3s &phi;<sub>s</sub> | Total | Mean | Median | Range | 5s &phi;<sub>s</sub> | Total | Mean | Median | Range | 7.5s &phi;<sub>s</sub> | Total | Mean | Median | Range | 10s &phi;<sub>s</sub> | Total | Mean | Median | Range |
|-----|-----|-----|-----|-----|-----|-----|-----|-----|-----|-----|-----|-----|-----|-----|-----|-----|-----|-----|-----|
|  | 0.5 | 0.5 | 0.52 | [0.3 0.7] |  | 0.58 | 0.58 | 0.59 | [0.34 0.71] |  | 0.64 | 0.65 | 0.66 | [0.41 0.82] |  | 0.62 | 0.63 | 0.65 | [0.27 0.74] |
...
| Period (s) | Full &phi;<sub>s</sub> | Downsampled median &phi;<sub>s</sub> | Downsampled &phi;<sub>s</sub> std. dev. | Downsampled &phi;<sub>s</sub> 68% conf range | Downsampled &phi;<sub>s</sub> 95% conf range |
|-----|-----|-----|-----|-----|-----|
| T-independent | 0.57 | 0.57 | 0.05 | [0.51 0.63] | [0.47 0.67] |
| 1 | 0.59 | 0.58 | 0.1 | [0.48 0.68] | [0.39 0.77] |
| 2 | 0.58 | 0.59 | 0.11 | [0.47 0.71] | [0.28 0.77] |
| 3 | 0.5 | 0.51 | 0.07 | [0.45 0.58] | [0.33 0.63] |
| 4 | 0.5 | 0.51 | 0.06 | [0.43 0.56] | [0.34 0.59] |
| 5 | 0.58 | 0.59 | 0.07 | [0.51 0.64] | [0.44 0.69] |
| 7.5 | 0.64 | 0.64 | 0.05 | [0.58 0.69] | [0.51 0.73] |
| 10 | 0.62 | 0.62 | 0.05 | [0.58 0.66] | [0.51 0.7] |
...
| 3s &phi;<sub>s</sub> | Total | Mean | Median | Range | 5s &phi;<sub>s</sub> | Total | Mean | Median | Range | 7.5s &phi;<sub>s</sub> | Total | Mean | Median | Range | 10s &phi;<sub>s</sub> | Total | Mean | Median | Range |
|-----|-----|-----|-----|-----|-----|-----|-----|-----|-----|-----|-----|-----|-----|-----|-----|-----|-----|-----|-----|
|  | 0.53 | 0.52 | 0.53 | [0.26 0.71] |  | 0.61 | 0.61 | 0.63 | [0.36 0.74] |  | 0.65 | 0.66 | 0.68 | [0.48 0.86] |  | 0.55 | 0.56 | 0.56 | [0.36 0.73] |
...
| Period (s) | Full &phi;<sub>s</sub> | Downsampled median &phi;<sub>s</sub> | Downsampled &phi;<sub>s</sub> std. dev. | Downsampled &phi;<sub>s</sub> 68% conf range | Downsampled &phi;<sub>s</sub> 95% conf range |
|-----|-----|-----|-----|-----|-----|
| T-independent | 0.56 | 0.57 | 0.06 | [0.5 0.62] | [0.45 0.66] |
| 1 | 0.58 | 0.57 | 0.11 | [0.47 0.7] | [0.35 0.77] |
| 2 | 0.54 | 0.53 | 0.11 | [0.42 0.64] | [0.26 0.73] |
| 3 | 0.53 | 0.54 | 0.09 | [0.42 0.62] | [0.33 0.69] |
| 4 | 0.48 | 0.48 | 0.06 | [0.43 0.54] | [0.35 0.61] |
| 5 | 0.61 | 0.62 | 0.08 | [0.52 0.69] | [0.42 0.74] |
| 7.5 | 0.65 | 0.65 | 0.05 | [0.6 0.7] | [0.54 0.74] |
| 10 | 0.55 | 0.55 | 0.05 | [0.51 0.6] | [0.45 0.67] |
...
| 3s &phi;<sub>s</sub> | Total | Mean | Median | Range | 5s &phi;<sub>s</sub> | Total | Mean | Median | Range | 7.5s &phi;<sub>s</sub> | Total | Mean | Median | Range | 10s &phi;<sub>s</sub> | Total | Mean | Median | Range |
|-----|-----|-----|-----|-----|-----|-----|-----|-----|-----|-----|-----|-----|-----|-----|-----|-----|-----|-----|-----|
|  | 0.52 | 0.51 | 0.53 | [0.26 0.71] |  | 0.55 | 0.55 | 0.54 | [0.27 0.74] |  | 0.56 | 0.56 | 0.62 | [0.23 0.86] |  | 0.5 | 0.49 | 0.56 | [0.15 0.74] |
...
| Period (s) | Full &phi;<sub>s</sub> | Downsampled median &phi;<sub>s</sub> | Downsampled &phi;<sub>s</sub> std. dev. | Downsampled &phi;<sub>s</sub> 68% conf range | Downsampled &phi;<sub>s</sub> 95% conf range |
|-----|-----|-----|-----|-----|-----|
| T-independent | 0.54 | 0.53 | 0.02 | [0.52 0.56] | [0.49 0.58] |
| 1 | 0.58 | 0.58 | 0.04 | [0.53 0.61] | [0.47 0.65] |
| 2 | 0.57 | 0.56 | 0.04 | [0.53 0.6] | [0.48 0.64] |
| 3 | 0.52 | 0.51 | 0.03 | [0.48 0.55] | [0.45 0.57] |
| 4 | 0.49 | 0.48 | 0.02 | [0.46 0.51] | [0.43 0.53] |
| 5 | 0.55 | 0.55 | 0.03 | [0.53 0.58] | [0.5 0.6] |
| 7.5 | 0.56 | 0.56 | 0.02 | [0.54 0.58] | [0.52 0.6] |
| 10 | 0.5 | 0.5 | 0.02 | [0.49 0.51] | [0.47 0.53] |
...
|-----|-----|-----|-----|-----|-----|
| T-independent | 0.48 | 0.48 | 0.05 | [0.42 0.51] | [0.37 0.54] |
| 1 | 0.58 | 0.56 | 0.09 | [0.48 0.66] | [0.42 0.72] |
| 2 | 0.59 | 0.58 | 0.08 | [0.48 0.65] | [0.41 0.69] |
| 3 | 0.51 | 0.52 | 0.07 | [0.43 0.57] | [0.36 0.63] |
| 4 | 0.48 | 0.48 | 0.06 | [0.43 0.53] | [0.35 0.59] |
| 5 | 0.46 | 0.47 | 0.05 | [0.42 0.5] | [0.37 0.56] |
| 7.5 | 0.36 | 0.36 | 0.03 | [0.32 0.38] | [0.3 0.42] |
| 10 | 0.27 | 0.27 | 0.03 | [0.24 0.29] | [0.21 0.34] |
...
These plots show the dependence of &phi;<sub>SS</sub> to the number of events included and the number of recordings per event. The left plot holds the number of recordings per event fixed at the full set of simulated recordings (18), varying the number of events. The right plot holds the number of events fixed at the full set of simulated events (78), varying the number of recordings per event.
...
| Period (s) | Full &phi;<sub>SS</sub> | Downsampled median &phi;<sub>SS</sub> | Downsampled &phi;<sub>SS</sub> std. dev. | Downsampled &phi;<sub>SS</sub> 68% conf range | Downsampled &phi;<sub>SS</sub> 95% conf range |
|-----|-----|-----|-----|-----|-----|
| T-independent | 0.57 | 0.57 | 0.05 | [0.5 0.62] | [0.47 0.68] |
| 1 | 0.59 | 0.59 | 0.1 | [0.46 0.69] | [0.39 0.78] |
| 2 | 0.58 | 0.58 | 0.12 | [0.42 0.69] | [0.31 0.77] |
| 3 | 0.5 | 0.5 | 0.08 | [0.41 0.58] | [0.33 0.62] |
| 4 | 0.5 | 0.51 | 0.06 | [0.45 0.56] | [0.34 0.59] |
| 5 | 0.58 | 0.58 | 0.07 | [0.51 0.65] | [0.41 0.69] |
| 7.5 | 0.64 | 0.64 | 0.06 | [0.58 0.69] | [0.51 0.76] |
| 10 | 0.62 | 0.62 | 0.05 | [0.57 0.66] | [0.46 0.71] |
...
| Period (s) | Full &phi;<sub>SS</sub> | Downsampled median &phi;<sub>SS</sub> | Downsampled &phi;<sub>SS</sub> std. dev. | Downsampled &phi;<sub>SS</sub> 68% conf range | Downsampled &phi;<sub>SS</sub> 95% conf range |
|-----|-----|-----|-----|-----|-----|
| T-independent | 0.56 | 0.55 | 0.05 | [0.5 0.61] | [0.47 0.67] |
| 1 | 0.58 | 0.56 | 0.11 | [0.41 0.66] | [0.35 0.78] |
| 2 | 0.54 | 0.53 | 0.1 | [0.4 0.64] | [0.34 0.7] |
| 3 | 0.53 | 0.52 | 0.09 | [0.42 0.62] | [0.34 0.7] |
| 4 | 0.48 | 0.48 | 0.07 | [0.41 0.54] | [0.32 0.59] |
| 5 | 0.61 | 0.61 | 0.07 | [0.53 0.68] | [0.47 0.75] |
| 7.5 | 0.65 | 0.65 | 0.05 | [0.6 0.69] | [0.54 0.77] |
| 10 | 0.55 | 0.54 | 0.04 | [0.51 0.59] | [0.47 0.66] |
...
| Period (s) | Full &phi;<sub>SS</sub> | Downsampled median &phi;<sub>SS</sub> | Downsampled &phi;<sub>SS</sub> std. dev. | Downsampled &phi;<sub>SS</sub> 68% conf range | Downsampled &phi;<sub>SS</sub> 95% conf range |
|-----|-----|-----|-----|-----|-----|
| T-independent | 0.54 | 0.54 | 0.02 | [0.52 0.56] | [0.5 0.58] |
| 1 | 0.58 | 0.58 | 0.04 | [0.54 0.62] | [0.5 0.65] |
| 2 | 0.57 | 0.57 | 0.04 | [0.53 0.61] | [0.49 0.64] |
| 3 | 0.52 | 0.51 | 0.03 | [0.48 0.54] | [0.44 0.57] |
| 4 | 0.49 | 0.48 | 0.02 | [0.46 0.51] | [0.44 0.52] |
| 5 | 0.55 | 0.55 | 0.02 | [0.53 0.58] | [0.5 0.59] |
| 7.5 | 0.56 | 0.57 | 0.02 | [0.55 0.58] | [0.53 0.6] |
| 10 | 0.5 | 0.5 | 0.02 | [0.49 0.52] | [0.47 0.54] |
...
|-----|-----|-----|-----|-----|-----|-----|-----|-----|-----|-----|-----|
| 0.41 | -3.21 | [-4.16 -2.56] | 0.4 | -3.67 | [-4.72 -3.17] | 0.36 | -4.2 | [-5.11 -3.7] | 0.32 | -4.82 | [-5.83 -4.41] |
...
|-----|-----|-----|-----|-----|-----|
| T-independent | 0.36 | 0.37 | 0.11 | [0.26 0.49] | [0.19 0.6] |
| 1 | 0.25 | 0.31 | 0.12 | [0.2 0.45] | [0.11 0.57] |
| 2 | 0.47 | 0.49 | 0.16 | [0.31 0.64] | [0.13 0.83] |
| 3 | 0.41 | 0.41 | 0.15 | [0.28 0.57] | [0.12 0.71] |
| 4 | 0.31 | 0.33 | 0.13 | [0.2 0.47] | [0.09 0.61] |
| 5 | 0.4 | 0.4 | 0.15 | [0.24 0.55] | [0.12 0.69] |
| 7.5 | 0.36 | 0.33 | 0.13 | [0.21 0.49] | [0.11 0.61] |
| 10 | 0.32 | 0.28 | 0.13 | [0.18 0.46] | [0.12 0.6] |
...
| 3s &tau; | Mean &delta;B<sub>e</sub> | &delta;B<sub>e</sub> Range | 5s &tau; | Mean &delta;B<sub>e</sub> | &delta;B<sub>e</sub> Range | 7.5s &tau; | Mean &delta;B<sub>e</sub> | &delta;B<sub>e</sub> Range | 10s &tau; | Mean &delta;B<sub>e</sub> | &delta;B<sub>e</sub> Range |
|-----|-----|-----|-----|-----|-----|-----|-----|-----|-----|-----|-----|
| 0.5 | -4.01 | [-5.12 -3.29] | 0.37 | -4.48 | [-5.72 -3.95] | 0.35 | -4.95 | [-5.86 -4.41] | 0.35 | -5.45 | [-6.31 -5.02] |
...
| Period (s) | Full &tau; | Downsampled median &tau; | Downsampled &tau; std. dev. | Downsampled &tau; 68% conf range | Downsampled &tau; 95% conf range |
|-----|-----|-----|-----|-----|-----|
| T-independent | 0.38 | 0.33 | 0.17 | [0.2 0.6] | [0.11 0.75] |
| 1 | 0.23 | 0.28 | 0.14 | [0.12 0.43] | [0.06 0.58] |
| 2 | 0.48 | 0.42 | 0.23 | [0.21 0.74] | [0.09 0.92] |
| 3 | 0.5 | 0.42 | 0.24 | [0.21 0.69] | [0.08 0.99] |
| 4 | 0.34 | 0.25 | 0.18 | [0.15 0.5] | [0.05 0.73] |
| 5 | 0.37 | 0.32 | 0.2 | [0.16 0.63] | [0.09 0.83] |
| 7.5 | 0.35 | 0.35 | 0.2 | [0.15 0.55] | [0.04 0.79] |
| 10 | 0.35 | 0.31 | 0.19 | [0.14 0.57] | [0.07 0.81] |
...
| 3s &tau; | Mean &delta;B<sub>e</sub> | &delta;B<sub>e</sub> Range | 5s &tau; | Mean &delta;B<sub>e</sub> | &delta;B<sub>e</sub> Range | 7.5s &tau; | Mean &delta;B<sub>e</sub> | &delta;B<sub>e</sub> Range | 10s &tau; | Mean &delta;B<sub>e</sub> | &delta;B<sub>e</sub> Range |
|-----|-----|-----|-----|-----|-----|-----|-----|-----|-----|-----|-----|
| 0.58 | -4.64 | [-5.85 -3.9] | 0.37 | -5.17 | [-6.35 -4.62] | 0.38 | -5.44 | [-6.58 -4.9] | 0.36 | -5.88 | [-6.81 -5.45] |
...
| Period (s) | Full &tau; | Downsampled median &tau; | Downsampled &tau; std. dev. | Downsampled &tau; 68% conf range | Downsampled &tau; 95% conf range |
|-----|-----|-----|-----|-----|-----|
| T-independent | 0.4 | 0.27 | 0.18 | [0.14 0.49] | [0.07 0.85] |
| 1 | 0.35 | 0.29 | 0.2 | [0.07 0.55] | [0.01 0.72] |
| 2 | 0.41 | 0.24 | 0.22 | [0.09 0.56] | [0.01 0.91] |
| 3 | 0.58 | 0.42 | 0.3 | [0.09 0.76] | [0.02 1.09] |
| 4 | 0.36 | 0.23 | 0.21 | [0.05 0.45] | [0 0.89] |
| 5 | 0.37 | 0.27 | 0.22 | [0.1 0.46] | [0 1.08] |
| 7.5 | 0.38 | 0.23 | 0.24 | [0.08 0.55] | [0.01 1] |
| 10 | 0.36 | 0.25 | 0.23 | [0.05 0.54] | [0 0.83] |
...
| 3s &tau; | Mean &delta;B<sub>e</sub> | &delta;B<sub>e</sub> Range | 5s &tau; | Mean &delta;B<sub>e</sub> | &delta;B<sub>e</sub> Range | 7.5s &tau; | Mean &delta;B<sub>e</sub> | &delta;B<sub>e</sub> Range | 10s &tau; | Mean &delta;B<sub>e</sub> | &delta;B<sub>e</sub> Range |
|-----|-----|-----|-----|-----|-----|-----|-----|-----|-----|-----|-----|
| 0.5 | -3.95 | [-5.85 -2.56] | 0.38 | -4.44 | [-6.35 -3.17] | 0.36 | -4.87 | [-6.58 -3.7] | 0.34 | -5.38 | [-6.81 -4.41] |
...
| Period (s) | Full &tau; | Downsampled median &tau; | Downsampled &tau; std. dev. | Downsampled &tau; 68% conf range | Downsampled &tau; 95% conf range |
|-----|-----|-----|-----|-----|-----|
| T-independent | 0.38 | 0.39 | 0.06 | [0.32 0.44] | [0.28 0.49] |
| 1 | 0.28 | 0.29 | 0.05 | [0.25 0.34] | [0.21 0.41] |
| 2 | 0.45 | 0.45 | 0.07 | [0.38 0.52] | [0.33 0.6] |
| 3 | 0.5 | 0.5 | 0.08 | [0.41 0.58] | [0.33 0.64] |
| 4 | 0.34 | 0.33 | 0.07 | [0.26 0.41] | [0.19 0.48] |
| 5 | 0.38 | 0.38 | 0.08 | [0.29 0.45] | [0.22 0.52] |
| 7.5 | 0.36 | 0.36 | 0.07 | [0.3 0.45] | [0.24 0.52] |
| 10 | 0.34 | 0.34 | 0.07 | [0.28 0.42] | [0.21 0.47] |
