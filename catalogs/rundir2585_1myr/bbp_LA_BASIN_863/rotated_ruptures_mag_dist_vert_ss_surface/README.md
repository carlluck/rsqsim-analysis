...
|-----|-----|-----|-----|-----|-----|-----|-----|-----|-----|-----|
| **M6.6 SS** | **PASS** | *(PASS)* | *(PASS)* | *(PASS)* | *(PASS)* | *(PASS)* | *(PASS)* | *(PASS)* | *(PASS)* | *(PASS)* |
| **M7.2 SS** | *(FAIL)* | *(FAIL)* | *(FAIL)* | *(FAIL)* | *(FAIL)* | *(FAIL)* | *(FAIL)* | *(FAIL)* | *(FAIL)* | *(FAIL)* |
...
|-----|-----|-----|-----|-----|-----|-----|-----|-----|-----|
| ![PartB Plot](resources/bbp_partB_m6p6_vert_ss_surface_20km.png) | ![PartB Plot](resources/bbp_partB_m6p6_vert_ss_surface_40km.png) | ![PartB Plot](resources/bbp_partB_m6p6_vert_ss_surface_60km.png) | ![PartB Plot](resources/bbp_partB_m6p6_vert_ss_surface_80km.png) | ![PartB Plot](resources/bbp_partB_m6p6_vert_ss_surface_100km.png) | ![PartB Plot](resources/bbp_partB_m6p6_vert_ss_surface_120km.png) | ![PartB Plot](resources/bbp_partB_m6p6_vert_ss_surface_140km.png) | ![PartB Plot](resources/bbp_partB_m6p6_vert_ss_surface_160km.png) | ![PartB Plot](resources/bbp_partB_m6p6_vert_ss_surface_180km.png) | ![PartB Plot](resources/bbp_partB_m6p6_vert_ss_surface_200km.png) |
...
| 20.0 km | 40.0 km | 60.0 km | 80.0 km | 100.0 km | 120.0 km | 140.0 km | 160.0 km | 180.0 km | 200.0 km |
|-----|-----|-----|-----|-----|-----|-----|-----|-----|-----|
| ![PartB Plot](resources/bbp_partB_m7p2_vert_ss_surface_20km.png) | ![PartB Plot](resources/bbp_partB_m7p2_vert_ss_surface_40km.png) | ![PartB Plot](resources/bbp_partB_m7p2_vert_ss_surface_60km.png) | ![PartB Plot](resources/bbp_partB_m7p2_vert_ss_surface_80km.png) | ![PartB Plot](resources/bbp_partB_m7p2_vert_ss_surface_100km.png) | ![PartB Plot](resources/bbp_partB_m7p2_vert_ss_surface_120km.png) | ![PartB Plot](resources/bbp_partB_m7p2_vert_ss_surface_140km.png) | ![PartB Plot](resources/bbp_partB_m7p2_vert_ss_surface_160km.png) | ![PartB Plot](resources/bbp_partB_m7p2_vert_ss_surface_180km.png) | ![PartB Plot](resources/bbp_partB_m7p2_vert_ss_surface_200km.png) |
