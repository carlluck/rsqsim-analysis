# Bruce 3164 Rotated Rupture Variability, M7.6 Reverse
...
|-----|-----|-----|
| Rupture | 5 | Unique (but similar in faulting style and magnitude) ruptures which match the given scenario. |
| Site | 1 | Unique site locations. If 3-d, each will have unique velocity profiles. |
| Rupture Strike | 18 | Rupture strike conforming to the Aki & Richards (1980) convention, where dipping faults dip to the right of the rupture. If path rotation is also performed, this azimuth is relative to the path. |
| Path | 1 | Path from the site to the centroid of the rupture, in azimuthal degrees (0 is North) |
| Distance | 20.0, 50.0, 100.0 km | 3-dimensional distance between the site and the rupture surface. |
| **Total # Simulations** | **270** | Total number of combinations of the above. |

## M7.6 Reverse RSQSim Rupture Match Criteria
*[(top)](#table-of-contents)*

We condisder 5 events in the catalog which match the following criteria:
...
|-----|-----|-----|-----|-----|-----|-----|
| Source-strike | &phi;<sub>s</sub> | 20 km | 0.53 | 0.44 | 0.41 | 0.38 |
| Source-strike | &phi;<sub>s</sub> | 50 km | 0.37 | 0.38 | 0.37 | 0.31 |
| Source-strike | &phi;<sub>s</sub> | 100 km | 0.34 | 0.31 | 0.34 | 0.36 |
| Within-event, single-site | &phi;<sub>SS</sub> | 20 km | 0.53 | 0.44 | 0.41 | 0.38 |
| Within-event, single-site | &phi;<sub>SS</sub> | 50 km | 0.37 | 0.38 | 0.37 | 0.31 |
| Within-event, single-site | &phi;<sub>SS</sub> | 100 km | 0.34 | 0.31 | 0.34 | 0.36 |
| Between-events | &tau; | 20 km | 0.14 | 0.15 | 0.17 | 0.22 |
| Between-events | &tau; | 50 km | 0.06 | 0.2 | 0.25 | 0.19 |
| Between-events | &tau; | 100 km | 0.08 | 0.09 | 0.18 | 0.2 |
...
|-----|-----|-----|-----|-----|-----|-----|-----|-----|-----|-----|-----|-----|-----|-----|-----|-----|-----|-----|-----|
|  | 0.53 | 0.53 | 0.55 | [0.38 0.62] |  | 0.44 | 0.44 | 0.46 | [0.33 0.52] |  | 0.41 | 0.41 | 0.39 | [0.28 0.51] |  | 0.38 | 0.37 | 0.32 | [0.28 0.48] |
...
| 3s &phi;<sub>s</sub> | Total | Mean | Median | Range | 5s &phi;<sub>s</sub> | Total | Mean | Median | Range | 7.5s &phi;<sub>s</sub> | Total | Mean | Median | Range | 10s &phi;<sub>s</sub> | Total | Mean | Median | Range |
|-----|-----|-----|-----|-----|-----|-----|-----|-----|-----|-----|-----|-----|-----|-----|-----|-----|-----|-----|-----|
|  | 0.37 | 0.37 | 0.34 | [0.31 0.46] |  | 0.38 | 0.37 | 0.34 | [0.29 0.54] |  | 0.37 | 0.36 | 0.34 | [0.26 0.5] |  | 0.31 | 0.31 | 0.32 | [0.2 0.41] |
...
| 3s &phi;<sub>s</sub> | Total | Mean | Median | Range | 5s &phi;<sub>s</sub> | Total | Mean | Median | Range | 7.5s &phi;<sub>s</sub> | Total | Mean | Median | Range | 10s &phi;<sub>s</sub> | Total | Mean | Median | Range |
|-----|-----|-----|-----|-----|-----|-----|-----|-----|-----|-----|-----|-----|-----|-----|-----|-----|-----|-----|-----|
|  | 0.34 | 0.34 | 0.31 | [0.3 0.41] |  | 0.31 | 0.31 | 0.32 | [0.2 0.42] |  | 0.34 | 0.33 | 0.32 | [0.22 0.46] |  | 0.36 | 0.35 | 0.39 | [0.23 0.48] |
...
|-----|-----|-----|-----|-----|-----|-----|-----|-----|-----|-----|-----|
| 0.14 | -2.65 | [-2.86 -2.53] | 0.15 | -3.46 | [-3.65 -3.27] | 0.17 | -4.04 | [-4.19 -3.76] | 0.22 | -4.54 | [-4.79 -4.24] |
...
| 3s &tau; | Mean &delta;B<sub>e</sub> | &delta;B<sub>e</sub> Range | 5s &tau; | Mean &delta;B<sub>e</sub> | &delta;B<sub>e</sub> Range | 7.5s &tau; | Mean &delta;B<sub>e</sub> | &delta;B<sub>e</sub> Range | 10s &tau; | Mean &delta;B<sub>e</sub> | &delta;B<sub>e</sub> Range |
|-----|-----|-----|-----|-----|-----|-----|-----|-----|-----|-----|-----|
| 0.06 | -3.46 | [-3.56 -3.4] | 0.2 | -4.07 | [-4.26 -3.78] | 0.25 | -4.61 | [-4.86 -4.26] | 0.19 | -5.05 | [-5.22 -4.81] |
...
| 3s &tau; | Mean &delta;B<sub>e</sub> | &delta;B<sub>e</sub> Range | 5s &tau; | Mean &delta;B<sub>e</sub> | &delta;B<sub>e</sub> Range | 7.5s &tau; | Mean &delta;B<sub>e</sub> | &delta;B<sub>e</sub> Range | 10s &tau; | Mean &delta;B<sub>e</sub> | &delta;B<sub>e</sub> Range |
|-----|-----|-----|-----|-----|-----|-----|-----|-----|-----|-----|-----|
| 0.08 | -3.91 | [-4 -3.84] | 0.09 | -4.56 | [-4.68 -4.48] | 0.18 | -5.04 | [-5.19 -4.72] | 0.2 | -5.36 | [-5.52 -5.11] |
